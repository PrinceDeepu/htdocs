...
class OfflineYoutube {
            ...
            await myObserver( this.btnContainer , btnContainer => {
                ...
                if( this.addLocation === 'append' )
                    if( this.btnContainerNode !== null )
                        btnContainer[this.btnContainerNode].appendChild(this.buttonElement);
                    else
                        btnContainer.appendChild(this.buttonElement);
                else if ( this.addLocation === 'after' )
                    if( this.btnContainerNode !== null )
                        btnContainer[this.btnContainerNode].after(this.buttonElement);
                    else
                        btnContainer.after(this.buttonElement);
    ...
    ajaxRequest ( options = null, ytUrl = 'https://www.youtube.com/watch?v=hu8MHIBeG4M' ) {
